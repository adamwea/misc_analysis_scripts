...
import os
import datetime
from RBS_network_models.sensitivity_analysis import run_sensitivity_analysis_v2, plot_sensitivity_analysis_v3
...
#from RBS_network_models.Organoid_RTT_R270X.DIV112_WT.src.fitness_targets import fitnessFuncArgs
from RBS_network_models.Organoid_RTT_R270X.DIV112_WT.src.evol_params import params as evol_params
# globals ===================================================================================================
...
def prep_output_dirs():
    ...
    # # aw 2025-03-12 15:30:06 - use cdkl5 data as a base.
    # aw 2025-03-13 14:12:49 - rerun as overrideWT with override in prepcfg.
    # pscratch/sd/a/adammwea/workspace/RBS_network_models/data/CDKL5/DIV21/batch_runs/batch_2025-02-09/gen_20/gen_20_cand_4_data.pkl
    # data_dir = '/pscratch/sd/a/adammwea/workspace/RBS_network_models/data/'
    # project_dir = 'CDKL5/DIV21/'
    # ref_path = 'network_metrics/CDKL5-E6D_T2_C1_05212024/240611/M08029/Network/000091/well005/network_metrics.npy'
    # batch_dir = 'batch_runs/batch_2025-02-09/gen_20/'
    # cand_path = 'gen_20_cand_4_data.pkl'
    
    # # aw 2025-03-13 11:52:57
    # # /pscratch/sd/a/adammwea/workspace/RBS_network_models/data/CDKL5/DIV21/sensitivity_analyses/2025-03-12_gen_20_cand_4_data_65s_1/propVelocity_3/propVelocity_3_data.pkl
    # data_dir = '/pscratch/sd/a/adammwea/workspace/RBS_network_models/data/'
    # project_dir = 'CDKL5/DIV21/'
    # ref_path = 'network_metrics/CDKL5-E6D_T2_C1_05212024/240611/M08029/Network/000091/well005/network_metrics.npy'
    # batch_dir = 'sensitivity_analyses/2025-03-12_gen_20_cand_4_data_65s_1/'
    # cand_path = 'propVelocity_3/propVelocity_3_data.pkl'
    
    # # aw 2025-03-13 14:13:14 - when available, going to run on overrided WT data to make MUT data.
    # notabley, the overrided code will be removed for this run.
    # /pscratch/sd/a/adammwea/workspace/RBS_network_models/data/Organoid_RTT_R270X/DIV112_WT/modified_simulations/slower_propVelocity_2025-03-13_17-06-42/propVelocity_3_slower_propVelocity__data.pkl
    data_dir = '/pscratch/sd/a/adammwea/workspace/RBS_network_models/data/'
    project_dir = 'Organoid_RTT_R270X/DIV112_WT/'
    ref_path = 'network_metrics/Organoid_RTT_R270X_pA_pD_B1_d91/250107/M07297/Network/000028/well005/network_metrics.npy'
    batch_dir = 'modified_simulations/slower_propVelocity_2025-03-13_17-06-42/'
    cand_path = 'propVelocity_3_slower_propVelocity__data.pkl'    
    ...
    # additional flag for run_label if needed
    #kwargs['run_label'] = kwargs['run_label'] + '_overrideWT_1'
    #kwargs['run_label'] = kwargs['run_label'] + '_overrideMUT'
    kwargs['run_label'] = kwargs['run_label'] + '_overrideMUT_2_axes'
...
if __name__ == '__main__':
    ...
    run_analysis = False
    #plot_analysis = False # force plot_analysis to false
    
    # main analysis steps
    if run_analysis: run_sensitivity_analysis_v2(kwargs)  # run_analysis
    if plot_analysis: plot_sensitivity_analysis_v3(kwargs)  # plot sensitivity analysis
...
python /pscratch/sd/a/adammwea/workspace/RBS_network_models/RBS_network_models/Organoid_RTT_R270X/DIV112_WT/scripts/run_sensitivity_analysis.py
'''