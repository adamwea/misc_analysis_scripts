...
#updated pathing for endpints
globus ls $NERSC_DTN_endpoint:/pscratch/sd/a/adammwea # pscratch is better at i/o than /global so its better to send data I think
