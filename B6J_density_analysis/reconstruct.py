...
input_dirs = [
    ...
    #"/global/homes/a/adammwea/pscratch/zinputs/B6J_DensityTest_10012024_AR/B6J_DensityTest_10012024_AR/241104", # Example directory with h5 files
    #"/global/homes/a/adammwea/pscratch/zinputs/B6J_DensityTest_10012024_AR/B6J_DensityTest_10012024_AR/241104/M06804/AxonTracking/000172", # Example subdirectory with h5 files
    
    # aw 2025-04-03 13:33:12 - using data that I expect to be good for debugging
    "/global/homes/a/adammwea/pscratch/zinputs/B6J_DensityTest_10012024_AR/B6J_DensityTest_10012024_AR/241030/M08029/AxonTracking"
    ]
...
def run_pipeline_on_project_dirs(project_dirs, output_dir):
    ...
    def build_kwargs():
        ...
        kwargs = {
            ...
            'av_params': {
                'upsample': 20,  # Upsampling factor to better capture finer details (unitless). Higher values increase temporal resolution.
                ...
                #'max_distance_for_edge': 200.0,  # Maximum distance for creating graph edges (micrometers). Defines the maximum allowed distance between connected channels.
                #'max_distance_to_init': 400.0,  # Maximum distance to initial channel for creating edges (micrometers). Determines the initial connectivity range.
                ...
                'r2_threshold_for_outliers': 0.90,  # R-squared threshold for outlier detection (unitless). Defines the threshold below which the algorithm looks for outliers.
